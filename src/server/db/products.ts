...
export async function getProductCountryGroups({ userId, productId }: { userId: string, productId: string }) {
...
export async function getProductCountryGroupsInternal({ userId, productId }: { userId: string, productId: string }) {
...
export async function getProductInternal({ id, userId }: { id: string, userId: string }) {
    return await db.query.ProductTable.findFirst({
        where: ({ clerkUserId }, { eq }) => and(eq(clerkUserId, userId), eq(ProductTable.id, id))
    })
}
...
export async function deleteProduct({ userId, productId }: { userId: string, productId: string }) {
