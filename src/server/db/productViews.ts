...
async function getProductViewCountInternal({ userId, startDate }: { userId: string, startDate: Date }) {
...
export function getProductViewCount({ userId, startDate }: { userId: string, startDate: Date }) {
